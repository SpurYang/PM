				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								员工信息添加
								<small> <i class="icon-double-angle-right"></i> Add</small>
							</h1>
						</div>
						<!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.EName"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.ESex"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.EBithday"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.ESid"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.EDept"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.EPost"
												placeholder="FAX" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.EIndate"
												placeholder="FAX" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" name="empinf.ECardate"
												placeholder="FAX" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.EFormat"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.ESource"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.EPolitical"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ENation" id="form-field-1"
												placeholder="FAX" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ENaresidence"
												id="form-field-1" placeholder="FAX"
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EPhone" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EEmail" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EHeight" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.EBlood"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.EMarstatus"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EBirthplace"
												id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ERegplace" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.ERecord"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div>
												<select class="form-control" name="empinf.EDegree"
													id="form-field-select-1">
													<option value="">
														&nbsp;
													</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ESchool" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EProfession"
												id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.EGradate" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ETrialstatus"
												id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ETrstartdate"
												id="form-field-1" placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="empinf.ETrenddate" id="form-field-1"
												placeholder="" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="FAX"
												class="col-xs-10 col-sm-5" />
										</div>
									</div>
