						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" id="form1"
									...
									action="<%=basePath%>postback/postbackAction">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder=""员工编号
												class="col-xs-10 col-sm-5" name="postbackInf.psEid" value="&{post.psEid}" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="调转后的部门"
												class="col-xs-10 col-sm-5" />
										</div>
									</div>--%>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="调转后的岗位"
												class="col-xs-10 col-sm-5" name="postbackInf.psPost" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="postbackInf.psReason" class="form-control"
												id="textarea" placeholder="Default Text"></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<textarea name="postbackInf.psNote" class="form-control"
												id="textarea" placeholder="Default Text"></textarea>
