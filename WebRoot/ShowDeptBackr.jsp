						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									...
									<ul class="submenu">
										<li>
											<a href="Career.html"> <i class="icon-leaf"></i> 职业生涯信息维护
											</a>
										</li>
										<li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" id="form1"
									...
									action="<%=basePath%>postback/postbackAction5">
									<table id="sample-table-1"
										...
										<tbody>
											<c:forEach items="${sessionScope.list1}" var="list1">
												<tr>
													<td>
														<input type="text" id="form-field-1"
															class="col-xs-10 col-sm-5" value="${list1.dsEid}"
															name="deptBackInf.dsEid" />

													</td>
													<td>
														<input type="text" id="form-field-1"
															class="col-xs-10 col-sm-5" value="${list1.dsDept}"
															name="deptBackInf.dsDept" />

													</td>
													<td>
														<input type="text" id="form-field-1"
															class="col-xs-10 col-sm-5" value="${list1.dsType}"
															name="deptBackInf.dsType" />

													</td>
													<td>
														<textarea name="deptBackInf.dsReason" class="form-control"
													...
													<td>
														<textarea name="deptBackInf.dsNote" class="form-control"
															placeholder="" id="textarea">
													...
													<td>
														<input type="text" id="form-field-1"
															value="${list1.dsDate}" name="deptBackInf.dsDate" />

													</td>
													<td class="center">
														<input onclick="window.location.href='DeptTransfer.jsp'"
															name="Submit251" type="button" class="badge-primary"
															value="部门调动" style="color: #FFFFFF">

														<input
															onclick="window.location.href='<%=basePath%>postback/postbackAction3.action?id=${list1.dsEid}'"
															name="Submit251" type="button" class="badge-primary"
															value="删除" style="color: #FFFFFF">
														    <input name="Submit251" type="submit"
															class="badge-primary" value="更新" style="color: #FFFFFF">
													</td>
												</tr>
					...
					<div class="modal-body overflow-visible">
						<div class="row">
							...
							<div class="form-group">
								...
								<div>
									<input class="input-large" type="text" id="form-field-username"
...
<![endif]-->
		...
		<script type="text/javascript">
			if("
													ontouchend" in
													document) document.write("<script src='assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
		</script>
