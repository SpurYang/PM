					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post"   action="<%=basePath%>/updatepostinf.action?PId=${p.PId}">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 岗位名称 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Postname" class="col-xs-10 col-sm-5" name="PName" value="${p.PName}"/>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 岗位类型  </label>
                                           <div class="col-sm-9">
                                         <div>
														<select class="form-control" id="form-field-select-1" name="PType">
																<option value="">&nbsp;</option>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 岗位编制 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"  name="POrg" value="${p.POrg }"/>
										</div>
									</div>
										<div class="form-group">
