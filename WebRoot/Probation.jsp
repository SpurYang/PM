...
<html lang="en">
	<head>
		...
		<link rel="stylesheet"
			href="<%=basePath%>/assets/css/ace-skins.min.css" />
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle"> <img
								...
								<span class="user-info"> <small>欢迎光临,</small> Jason </span> <i
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="<%=basePath%>periodinf/periodinfAction"> <i
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<input name="Submit22" type="submit" class="badge-primary"
									value="已转正员工信息查询"
									style="float: right; margin-right: 80px; color: #FFFFFF" onclick="window.location.href=('<%=basePath%>Message.jsp')" />
							</h1>
						</div>
						<!-- /.page-header -->
						...
						<div class="table-responsive">
							<form>
								...
								<table id="sample-table-1"
									...
									<c:forEach items="${sessionScope.pei}" var="pei">
											<tr>
												<td class="center">
												<c:out value="${pei.EId}"></c:out>
												</td>
												<td><c:out value="${pei.EName}"></c:out>
												</td>
												<td><c:out value="${pei.EDept}"></c:out></td>
												<td><c:out value="${pei.EPost}"></c:out></td>
												<td><c:out value="${pei.peStatus}"></c:out></td>
												<td><c:out value="${pei.peSdate}"></c:out></td>
												<td><c:out value="${pei.peEdate}"></c:out></td>
												<td><c:out value="${pei.peComment}"></c:out></td>
												
												<td class="hidden-480">
													<form name="form1" method="post" action="">
													<a class="badge-success"
															value="转正" style="color: #FFFFFF" href="<%=basePath%>periodinf/updateAction.action?ETrialstatus=${pei.EId}">转正</a>
													<!-- <input  class="badge-success" value="转正" style="color: #FFFFFF"> -->
													
														<a class="badge-success"
															value="延期" style="color: #FFFFFF" href="<%=basePath%>ProbationAdd.jsp">延期</a>
														<a class="badge-pink"
															value="辞退" style="color: #FFFFFF" href="<%=basePath%>periodinf/deleteAction.action?EId=${pei.EId}">辞退</a>
													</form>
												</td>
											</tr>
										</c:forEach>	
